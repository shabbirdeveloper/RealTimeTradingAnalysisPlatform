...
/** Instruments priced by a real market, from a public quote vendor. */
export type MarketAssetSymbol = "XAUUSD" | "EURUSD" | "GBPUSD" | "BTCUSD" | "ETHUSD";

/**
 * Instruments generated by a broker rather than by any market. Kept as a
 * separate type, not merged into the list above, because spec section 72
 * requires their statistics never be pooled: a result on a broker's
 * synthetic series says nothing about a real market, and one union type
 * makes mixing them the path of least resistance.
 */
export type OtcAssetSymbol = "DERIV_V25" | "DERIV_V50" | "DERIV_V75";

export type AssetSymbol = MarketAssetSymbol | OtcAssetSymbol;
