...
import type { AssetSymbol, ExpiryMinutes } from "@/types";
...
export default function AnalyzerPage() {
  ...
  const signal = now ? generateSignal(asset, now) : null;
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Run the current analysis for any asset / expiry combination.</p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-5">
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
              ...
              <Row label="Meta model" value={candidate?.metaDecision ?? "—"} />
